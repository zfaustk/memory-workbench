...
- generated_at: `2026-03-28T01:32:39.019226+00:00`
...
Built a memory-workbench for long-running agents: 2 continuity benchmark cases + 1 scripted stale-state rerun, with 64.6% average replay-cost reduction and a published proof bundle that can be independently rerun.
...
| --- | --- | --- | --- |
| `docs` | `proof_surface` | `docs/proof-surface.md` | `14b2252c60cb` |
...
| `docs` | `target_system_eval_packet` | `docs/target-system-eval-packet.md` | `db75f9f26c3b` |
...
| `reports` | `proof_surface_json` | `reports/proof-surface-2026-03-27.json` | `0d97f5b0bcd4` |
...
| `reports` | `target_system_eval_packet` | `reports/target-system-eval-packet-2026-03-27.json` | `83195597b9d9` |
